...
public class CouponTests
{
    ...
    [Theory]
    [InlineData("TEST_CPN", 20, "2024-10-10", "2024-11-11")]
        ...
        string endDate)
    {
        ...
        var coupon = Coupon.Create(
            ...
            DateRange.FromString(startDate, endDate));
    ...
    [Theory]
    [InlineData("TEST_CPN", 20, "2024-10-10", "2024-11-11")]
    [InlineData("TEST_CPN", 56, "2022-10-10", "2023-06-11")]
    ...
    {
        //Arrange
        var amount = Amount.Percentage(value);
        var dateRange = DateRange.FromString(startDate, endDate);
    ...
    [Fact]
    public void Deactivate_WhenCouponIsAlreadyInactive_ShouldFail()
    {
        // Arrange
        var coupon = TestFactories.CouponFactory.Create();
        coupon.Deactivate();
