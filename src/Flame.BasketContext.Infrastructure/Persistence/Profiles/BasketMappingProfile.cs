...
namespace Flame.BasketContext.Infrastructure.Persistence.Profiles;
...
public class BasketMappingProfile : Profile
{
    public BasketMappingProfile()
    {
        ...
        CreateMap<BasketEntity, Basket>()
            ...
            .ForMember(dest => dest.Id,
                opt => opt.MapFrom(
                    src => src.Id))
            .ForMember(dest => dest.BasketItems,
                opt => opt.Ignore()) // Manual mapping for complex structure
        ...
        CreateMap<SellerEntity, Seller>()
            .ConstructUsing(entity => Seller.Create(
                entity.Id,
                entity.Name,
                entity.Rating,
                entity.ShippingLimit,
                entity.ShippingCost));

        CreateMap<CustomerEntity, Customer>()
            .ConstructUsing(entity => Customer.Create(
                entity.IsEliteMember,
                entity.Id));
    }
}